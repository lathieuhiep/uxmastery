...
class EFA_Widget_Service_Grid_V2 extends Widget_Base
{
    ...
    protected function register_controls(): void
    {
        ...
        $this->add_responsive_control(
            'thumbnail_height',
            [
                'label'      => esc_html__( 'Chiều cao', 'essential-features-addon' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%', 'em', 'rem' ],
                'range'      => [
                    'px' => [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .item .box-thumbnail a' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'title_margin',
            [
                'label' => esc_html__('Khoảng cách bên ngoài', 'essential-features-addon'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em', 'rem'],
                'default' => [
                    'unit' => 'px'
            ...
            <div class="efa-addon-service-grid-v2 efa-grid-layout">
                <?php while ($query->have_posts()): $query->the_post(); ?>
                    <div class="item efa-scale-hover">
                        ...
                        <h2 class="title">
                            <a class="typo-inherit efa-d-inline-block" href="<?php the_permalink(); ?>"
                               title="<?php the_title(); ?>">
                                <?php the_title(); ?>
                            </a>
                        </h2>
