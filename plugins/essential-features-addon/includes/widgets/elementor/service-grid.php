...
class EFA_Widget_Service_Grid extends Widget_Base {

	// widget name
	public function get_name(): string {
		return 'efa-service-grid';
	}

	// widget title
	public function get_title(): string {
		return esc_html__( 'Bài dịch vụ dạng lưới', 'essential-features-addon' );
	}
	...
	protected function render(): void {
		...
		if ( $query->have_posts() ) :
        ?>
            <div class="efa-addon-post-grid efa-addon-service-grid">
